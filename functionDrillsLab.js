...
function nameCheck(name){
  if(name === "Steven") {
    ...
    console.log('Hey Bryguy!');
  } else {
    console.log(`Cool name, ${name}`);
  }
}

let nameGreeting = nameCheck('Charles');
...
function faveColorFinder(color) {
  if(color === "red") {
    ...
    console.log(`${color}? Really? You need to evaluate your favorite color choice bro...`);
  }
}
...
//CODE HERE
function candyPurchase(gold) {
  let frog = 3;
  let candyAmount = Math.floor(gold / frog);
  //erase Math.floor for floating numbers of frogs
  return candyAmount; 
}

let totalFrogs = candyPurchase(10);
...
/* Refer to my answer in 12, Math.floor was used */
...
function isThisAscending (numarr) {
...
let arrayIsAscending = isThisAscending(sampleArray); 
